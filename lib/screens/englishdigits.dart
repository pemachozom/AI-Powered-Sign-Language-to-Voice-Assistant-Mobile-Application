...
class DigitsTranslation extends StatefulWidget {
  final Map<String, dynamic> token;

  const DigitsTranslation({Key? key, required this.token}) : super(key: key);

  @override
  State<DigitsTranslation> createState() => _DigitsTranslationState();
}

class _DigitsTranslationState extends State<DigitsTranslation> {
  ...
  Future<http.Response> sendImageToApi(XFile imageFile) async {
    ...
    // final apiUrl = 'http://192.168.1.48:5003/predict';
    final apiUrl = 'http://192.168.47.115:5003/predict';
