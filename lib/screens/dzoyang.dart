...
class DzongkhaYang extends StatefulWidget {
  final Map<String, dynamic> token;

  const DzongkhaYang({Key? key, required this.token}) : super(key: key);

  @override
  State<DzongkhaYang> createState() => _DzongkhaYangState();
}

class _DzongkhaYangState extends State<DzongkhaYang> {
  ...
  Future<http.Response> sendImageToApi(XFile imageFile) async {
    ...
    // final apiUrl = 'http://192.168.1.48:5005/predict';
    final apiUrl = 'http://192.168.47.115:5005/predict';
